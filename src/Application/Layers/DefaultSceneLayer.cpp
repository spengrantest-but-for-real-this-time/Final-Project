...
#pragma endregion 
		...
		Texture3D::Sptr warm = ResourceManager::CreateAsset<Texture3D>("luts/Custom.CUBE");
		Texture3D::Sptr custom = ResourceManager::CreateAsset<Texture3D>("luts/Warm.CUBE");
		...
		//Stool Material
		Material::Sptr stoolMaterial = ResourceManager::CreateAsset<Material>(deferredForward);
		{
			stoolMaterial->Name = "Stool";
			stoolMaterial->Set("u_Material.AlbedoMap", stoolTex);
			stoolMaterial->Set("u_Material.NormalMap", normalMapDefault);
		...
		//Balloon Material
		Material::Sptr balloonMaterial = ResourceManager::CreateAsset<Material>(deferredForward);
		{
			balloonMaterial->Name = "Balloon_Mat";
			balloonMaterial->Set("u_Material.AlbedoMap", balloonTex);
			balloonMaterial->Set("u_Material.NormalMap", normalMapDefault);
			balloonMaterial->Set("u_Material.Shininess", 0.1f);
		}
				//Campfire Material
		Material::Sptr fireMaterial = ResourceManager::CreateAsset<Material>(deferredForward);
		{
			fireMaterial->Name = "Campfire";
			fireMaterial->Set("u_Material.AlbedoMap", campfireTex);
			fireMaterial->Set("u_Material.NormalMap", normalMapDefault);
		...
		{
			// Set position in the scene
			shadowCaster->SetPostion(glm::vec3(-0.14f, 1.24f, 1.63f));
			shadowCaster->LookAt(glm::vec3(0.0f, 5.0f, -3.0f));
		...
		{
			// Set position in the scene
			shadowCaster2->SetPostion(glm::vec3(0.5f, -1.24f, 1.63f));
			shadowCaster2->LookAt(glm::vec3(0.0f, -5.0f, -3.0f));
		...
		{
			// Set position in the scene
			shadowCaster3->SetPostion(glm::vec3(-1.24f, 0.5f, 1.63f));
			shadowCaster3->LookAt(glm::vec3(-5.0f, 0.0f, -2.0f));
		...
		{
			// Set position in the scene
			shadowCaster4->SetPostion(glm::vec3(1.24f, 0.5f, 1.63f));
			shadowCaster4->LookAt(glm::vec3(5.0f, 0.0f, -3.0f));
		...
		{
			// Set position in the scene
			shadowCaster5->SetPostion(glm::vec3(-0.14f, 1.24f, 1.63f));
			shadowCaster5->LookAt(glm::vec3(0.0f, 5.0f, 3.0f));
		...
		GameObject::Sptr shadowCaster6 = scene->CreateGameObject("Shadow Light6");
		{
			// Set position in the scene
			shadowCaster6->SetPostion(glm::vec3(0.5f, -1.24f, 1.63f));
			shadowCaster6->LookAt(glm::vec3(0.0f, -5.0f, 3.0f));



			// Create and attach a renderer for the monkey
			ShadowCamera::Sptr shadowCam = shadowCaster6->Add<ShadowCamera>();
			shadowCam->SetProjection(glm::perspective(glm::radians(120.0f), 1.0f, 0.1f, 100.0f));
		}

		GameObject::Sptr shadowCaster7 = scene->CreateGameObject("Shadow Light7");
		{
			// Set position in the scene
			shadowCaster7->SetPostion(glm::vec3(-1.24f, 0.5f, 1.63f));
			shadowCaster7->LookAt(glm::vec3(-5.0f, 0.0f, 3.0f));



			// Create and attach a renderer for the monkey
			ShadowCamera::Sptr shadowCam = shadowCaster7->Add<ShadowCamera>();
			shadowCam->SetProjection(glm::perspective(glm::radians(120.0f), 1.0f, 0.1f, 100.0f));
		}


		GameObject::Sptr shadowCaster8 = scene->CreateGameObject("Shadow Light8");
		{
			// Set position in the scene
			shadowCaster8->SetPostion(glm::vec3(1.24f, 0.5f, 1.63f));
			shadowCaster8->LookAt(glm::vec3(5.0f, 0.0f, 3.0f));



			// Create and attach a renderer for the monkey
			ShadowCamera::Sptr shadowCam = shadowCaster8->Add<ShadowCamera>();
			shadowCam->SetProjection(glm::perspective(glm::radians(120.0f), 1.0f, 0.1f, 100.0f));
		}
		...
		GameObject::Sptr particles = scene->CreateGameObject("Particles"); 
		{
			particles->SetPostion({ 0.0f, 0.0f, 1.0f });
